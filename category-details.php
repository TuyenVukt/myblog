<?php
  ...
  if(isset($_GET['type']))
  {
    ...
    $sql = "SELECT count(id_blog) as total FROM blog WHERE id_type = $id_type";
    ...
    if($total_records != 0){
      ...
      $data = "SELECT * FROM blog WHERE id_type = $id_type ORDER BY date_upload DESC LIMIT $start, $limit";
