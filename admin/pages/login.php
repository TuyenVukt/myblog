...
<head>
    ...
    <title>Đăng nhập tài khoản- &copy;</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="index.html"><img class="logo-img" src="./public/images/avatars/logo.png" width="100%" alt="logo" style = "border-radius: 50%;
    max-width: 50%;"></a><span class="splash-description">Đăng nhập tài khoản</span></div>
            <div class="card-body">
                <form method="POST">
